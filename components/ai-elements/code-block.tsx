...
export const CodeBlockContent = ({
  ...
  // Invalidate stale async tokens synchronously during render (setState-during-render is
  // allowed in React for the component's own state — triggers an immediate re-render)
